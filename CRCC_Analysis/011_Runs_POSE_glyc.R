...
val        <- as.matrix(readRDS("CRCC_Analysis/Data/FinalMatrix_Glycans.RDS"))
...
for(i in 1:nsim){
  ...
  saveRDS(MOD,paste0("CRCC_Analysis/Output/RDS/All_runs_Glycans_Pose/Pose_4kGlycans_fisan_K30L40_epsilon1e-8_run#",i,".RDS"))
  rm(MOD)
  gc()
}
...
for(i in 1:nsim){
  x <- readRDS(paste0("CRCC_Analysis/Output/RDS/All_runs_Glycans_Pose/Pose_4kGlycans_fisan_K30L40_epsilon1e-8_run#",i,".RDS"))
  ELBOS[[i]] <- x$Elbo_val
  cat(i)
}
...
mod1 <- readRDS(paste0("CRCC_Analysis/Output/RDS/All_runs_Glycans_Pose/Pose_4kGlycans_fisan_K30L40_epsilon1e-8_run#",ind.max,".RDS"))
saveRDS(mod1,"CRCC_Analysis/Output/RDS/All_runs_Glycans_Pose/Best_Pose_4kGlycans.RDS")
